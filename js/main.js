...
const textBindings = [
  ...
  [".project-card:nth-child(4) h3", "projects.bars.title"],
  [".project-card:nth-child(4) .project-body > p:nth-of-type(1)", "projects.bars.desc"],
  [".project-card:nth-child(4) .tech-stack", "projects.bars.stack"],
  [".project-card:nth-child(4) .security-note", "projects.bars.note"],
  [".project-card:nth-child(5) h3", "projects.bni.title"],
  [".project-card:nth-child(5) .project-body > p:nth-of-type(1)", "projects.bni.desc"],
  [".project-card:nth-child(5) .tech-stack", "projects.bni.stack"],
  [".project-card:nth-child(5) .security-note", "projects.bni.note"],
  [".project-card:nth-child(6) h3", "projects.wsw.title"],
  [".project-card:nth-child(6) .project-body > p:nth-of-type(1)", "projects.wsw.desc"],
  [".project-card:nth-child(6) .tech-stack", "projects.wsw.stack"],
  [".project-card:nth-child(6) .security-note", "projects.wsw.note"],
  [".project-card:nth-child(7) h3", "projects.ctf.title"],
  [".project-card:nth-child(7) .project-body > p:nth-of-type(1)", "projects.ctf.desc"],
  [".project-card:nth-child(7) .tech-stack", "projects.ctf.stack"],
  [".project-card:nth-child(7) .security-note", "projects.ctf.note"],
  [".project-card:nth-child(1) .project-links a:first-child", "projects.github"],
  [".project-card:nth-child(2) .project-links a:first-child", "projects.github"],
  [".project-card:nth-child(3) .project-links a:first-child", "projects.github"],
  [".project-card:nth-child(4) .project-links a:nth-child(2)", "projects.github"],
  [".project-card:nth-child(5) .project-links a:nth-child(2)", "projects.github"],
  [".project-card:nth-child(6) .project-links a:nth-child(2)", "projects.github"],
  [".project-card:nth-child(7) .project-links a:first-child", "projects.github"],
  [".project-card:nth-child(-n+3) .project-links a:nth-child(2)", "projects.demo"],
  [".project-card:nth-child(4) .project-links a:first-child", "projects.liveSite"],
  [".project-card:nth-child(5) .project-links a:first-child", "projects.liveSite"],
  [".project-card:nth-child(6) .project-links a:first-child", "projects.liveSite"],
  [".project-card:nth-child(7) .project-links a:nth-child(2)", "projects.writeups"],

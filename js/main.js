...
const translations = {
  en: {
    ...
    "projects.summary":
      "Real websites, security tools, and learning writeups grouped by focus area.",
    "projects.softwareTitle": "Software Projects",
    "projects.softwareSummary":
      "Live websites built for ecommerce, business networking, and public event communication.",
    "projects.cyberTitle": "Cybersecurity Projects",
    "projects.cyberSummary": "Security-focused tools, labs, and writeups that show practical learning.",
  ...
  mn: {
    ...
    "projects.title": "Програм хангамж болон кибер аюулгүй байдлын сонгосон төслүүд.",
    "projects.summary": "Бодит вебсайт, security tool, learning writeup-уудыг чиглэлээр нь ангилсан.",
    "projects.softwareTitle": "Програм хангамжийн төслүүд",
    "projects.softwareSummary": "Ecommerce, бизнес нетворк, олон нийтийн event communication-д зориулсан live вебсайтууд.",
    "projects.cyberTitle": "Кибер аюулгүй байдлын төслүүд",
    "projects.cyberSummary": "Практик learning-ийг харуулах security-focused tool, lab, writeup-ууд.",
...
const textBindings = [
  ...
  [".software-category .project-category-heading h3", "projects.softwareTitle"],
  [".software-category .project-category-heading p", "projects.softwareSummary"],
  [".software-projects .project-card:nth-child(1) h3", "projects.bars.title"],
  [".software-projects .project-card:nth-child(1) .project-body > p:nth-of-type(1)", "projects.bars.desc"],
  [".software-projects .project-card:nth-child(1) .tech-stack", "projects.bars.stack"],
  [".software-projects .project-card:nth-child(1) .security-note", "projects.bars.note"],
  [".software-projects .project-card:nth-child(2) h3", "projects.bni.title"],
  [".software-projects .project-card:nth-child(2) .project-body > p:nth-of-type(1)", "projects.bni.desc"],
  [".software-projects .project-card:nth-child(2) .tech-stack", "projects.bni.stack"],
  [".software-projects .project-card:nth-child(2) .security-note", "projects.bni.note"],
  [".software-projects .project-card:nth-child(3) h3", "projects.wsw.title"],
  [".software-projects .project-card:nth-child(3) .project-body > p:nth-of-type(1)", "projects.wsw.desc"],
  [".software-projects .project-card:nth-child(3) .tech-stack", "projects.wsw.stack"],
  [".software-projects .project-card:nth-child(3) .security-note", "projects.wsw.note"],
  [".software-projects .project-card .project-links a:first-child", "projects.liveSite"],
  [".software-projects .project-card .project-links a:nth-child(2)", "projects.github"],
  [".cybersecurity-category .project-category-heading h3", "projects.cyberTitle"],
  [".cybersecurity-category .project-category-heading p", "projects.cyberSummary"],
  [".cyber-projects .project-card:nth-child(1) h3", "projects.passcheck.title"],
  [".cyber-projects .project-card:nth-child(1) .project-body > p:nth-of-type(1)", "projects.passcheck.desc"],
  [".cyber-projects .project-card:nth-child(1) .tech-stack", "projects.passcheck.stack"],
  [".cyber-projects .project-card:nth-child(1) .security-note", "projects.passcheck.note"],
  [".cyber-projects .project-card:nth-child(1) .project-links a:first-child", "projects.liveSite"],
  [".cyber-projects .project-card:nth-child(1) .project-links a:nth-child(2)", "projects.github"],
  [".cyber-projects .project-card:nth-child(2) h3", "projects.ctf.title"],
  [".cyber-projects .project-card:nth-child(2) .project-body > p:nth-of-type(1)", "projects.ctf.desc"],
  [".cyber-projects .project-card:nth-child(2) .tech-stack", "projects.ctf.stack"],
  [".cyber-projects .project-card:nth-child(2) .security-note", "projects.ctf.note"],
  [".cyber-projects .project-card:nth-child(2) .project-links a:first-child", "projects.writeups"],
  [".cyber-projects .project-card:nth-child(2) .project-links a:nth-child(2)", "projects.github"],
